<template lang="html">
    <div class="container mt-4">
        ...
        <div id="green-banner" class="row mx-1 mb-2">
            ...
            <div class="input-group mb-3">
                <input v-model="petBirthday" type="text" class="form-control" id="petBirthday" placeholder="Birthday">
        ...
        <div class="row">
            <div class="col">
                <div class="position-absolute start-50 translate-middle my-4">
                    <button type="button" id="green-banner" class="btn btn-outline-dark mt-2 py-1 px-2" @click="addPet">Add
                        Pet</button>
                </div>
            </div>
