...
//   const userId = req.user.uid;
//   const groupData = req.body; // Assuming the group data is provided in the request body
//   const groupsRef = database.ref('groups'); // Removed ${userId}
//   const newGroupRef = groupsRef.push(); // Use push to generate a new reference with a unique key
//   const newGroupKey = newGroupRef.key; // Get the unique key generated by push

//   newGroupRef.set(groupData)
//     .then(() => {
//       res.json({ message: 'Group created successfully', groupId: newGroupKey });
//     })
//     .catch((error) => {
